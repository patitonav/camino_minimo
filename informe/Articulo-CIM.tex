...
(1-6): Representa los distintos obstaculos.\par
...
Determinado el camino mínimo, para cada uno de los siguientes tamaños de poblaciones iniciales: 250, 500, 1000 y 2000;
 realizamos 100 ejecuciones del programa registrando: tiempos de ejecución total y promedio; cantidad de iteraciones y aptitud promedio, mínima y máxima. La condición de corte para estas ejecuciónes era llegar a una solución óptima con una aptitud de 10 o a un tope de 1000 generaciones de soluciones.
\section{Resultados}
...
\begin{figure}[!hbp]
	...
	\end{center}
	\caption{Tiempo promedio de procesamiento en 100 ejecuciónes del programa para distintos tamaños de población inicial.} \label{fig001}
\end{figure}
...
\begin{figure}[!hbp]
	...
	\end{center}
	\caption{Cantidad promedio de iteraciones en 100 ejecuciónes para encontrar una solución óptima.} \label{fig002}
\end{figure}
