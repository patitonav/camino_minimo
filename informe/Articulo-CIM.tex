...
Buscamos la solución ideal en llegar del 7 (el inicio) al 8 (el final). El sistema en el cual se probó el programa tiene la siguiente forma:
...
\section{Resultados}
El camino optimo obtenido tiene un valor de fitness de 10. Además, el tiempo promedio y la cantidad de iteraciones promedio necesarias varia segun la poblacion inicial.
