...
De la Figura 1 se deduce, a partir de sus valores registrados de aptitud e iteraciones máximas, que para un valor de 2000 soluciones iniciales se llegó a la óptima (de una aptitud igual a 10) en todas las 100 corridas del programa. Mientras que para el resto de los valores medidos si bien llegaron en algunos casos a la mejor solución en otros no lo hizo, llegando en los peores casos a 28. Esto se debe a que se limitó la cantidad de generaciones a 1000 para evitar largos tiempos de procesamiento.
\begin{figure}[!hbp]
	\begin{center}
