...
Buscamos la solución ideal en llegar desde el inicio hasta el final.\par

El sistema en el cual se probó el programa tiene la siguiente forma:\\
...
Se ejecuta una cruza de los distintos individuos en la población para obtener mejores y futuras generaciones y luego se aplica un proceso de mutación. En cada solución, se evalua la porción menos apta (con el menor valor de fitness) y se genera una porción nueva y aleatoria. Se vuelve a calcular el fitness nuevamente y, si es necesario, el proceso comienza nuevamente.
...
\section{Resultados}
El camino óptimo obtenido tiene un valor de fitness de 10. Además, el tiempo promedio y la cantidad de iteraciones promedio necesarias varia según la poblacion inicial.\par
